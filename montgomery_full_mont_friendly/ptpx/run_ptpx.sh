...
export VCD_NAME=${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${W}.vcd
...
/data/tools/Synopsys/primetime/prime/T-2022.03-SP2/bin/pt_shell -output_log_file ./pt_$DESIGN_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${W}_${TECH}_${CLK_PERIOD}.log -x   "source -echo -verbose ./run_pt.tcl"
