...
echo "---------------------Running vlogan-----------------"
   vlogan -kdb -sverilog +define+${TESTCASE} +define+DUTNAME=${DESIGN} +define+MUL_STAGE1=${MUL_STAGE1} +define+MUL_STAGE2=${MUL_STAGE2} +define+W=${W} +define+NUMBITS=${NBITS} +define+PBITS=$PBITS  +define+NUMTRACE=$NUMTRACE  -f verilog_files.txt  | tee vlogan.log
