...
mkdir vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}
...
echo "---------------------Running vlogan-----------------"
vlogan -kdb  -sverilog +define+VCD_NAME=\"vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}.vcd\"  +define+DUTNAME=${DESIGN}_MUL_STAGE1${MUL_STAGE1}_MUL_STAGE2${MUL_STAGE2}_MUL_STAGE3${MUL_STAGE3}_NBITS${NBITS}_PBITS${PBITS}  +define+CLKPERIOD=${CLKPERIOD} +define+MUL_STAGE1=${MUL_STAGE1} +define+MUL_STAGE2=${MUL_STAGE2} +define+MUL_STAGE3=${MUL_STAGE3} +define+${TESTCASE}=TRUE +define+NUMBITS=${NBITS} +define+PBITS=$PBITS  +define+NUMTRACE=$NUMTRACE $VERIF_LIBRARY ${TBENCH}.v ../synth/${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_synth_${TECH}_${CLKPERIOD}ns/netlist/${DESIGN}_flat.v   +delay_mode_zero +define+${INPUTMODE}=TRUE  | tee vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/vlogan.log
...
echo "---------------------vlogan Done--------------------"
echo "---------------------Running VCS--------------------"
vcs +lint=TFIPC-L -lca -V -kdb -y vcs -sverilog -debug_access+all $TBENCH -o vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/simv  | tee vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/vcs.log

echo "---------------------VCS    Done--------------------"
./vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/simv  +realperiod=$REALPERIOD   | tee vcs_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${CLKPERIOD}/simv.log
