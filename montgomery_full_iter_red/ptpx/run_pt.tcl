...
read_verilog  ../synth/${design}_${numbits}_${pbits}_${mul_stage1}_${mul_stage2}_${mul_stage3}_synth_${tech}_${clkperiod}ns/netlist/${design}_flat.v
...
read_vcd ../gls/vcs_${design}_${numbits}_${pbits}_${mul_stage1}_${mul_stage2}_${mul_stage3}_${clkperiod}/$vcd_name -zero_delay -strip_path $tbench/${design}_MUL_STAGE1${mul_stage1}_MUL_STAGE2${mul_stage2}_MUL_STAGE3${mul_stage3}_NBITS${numbits}_PBITS${pbits}
...
set_power_analysis_options -cycle_accurate_clock CLK -waveform_output $work_dir/${design}_${numbits}_${pbits}_${mul_stage1}_${mul_stage2}_${mul_stage3} -waveform_format out
update_power
report_power > $work_dir/power.rpt
report_power -verbose -hier -nosplit -sort_by name > $work_dir/power.hier.rpt
save_session -include libraries pt_session_${design}_${numbits}_${pbits}_${mul_stage1}_${mul_stage2}_${mul_stage3}
exit
