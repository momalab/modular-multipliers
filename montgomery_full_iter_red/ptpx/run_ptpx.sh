...
#export VCD_NAME=${DESIGN}_${NBITS}_${PBITS}.fsdb
export VCD_NAME=${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}.vcd
...
/data/tools/Synopsys/primetime/prime/T-2022.03-SP2/bin/pt_shell -output_log_file ./pt_${DESIGN}_${NBITS}_${PBITS}_${MUL_STAGE1}_${MUL_STAGE2}_${MUL_STAGE3}_${TECH}_${CLK_PERIOD}.log -x   "source -echo -verbose ./run_pt.tcl"
